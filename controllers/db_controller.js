...
module.exports.resetSystem = function(){
	...
	addServer();
	module.exports.insertEmployee(1000,'Dakoiro','male',2000.00,'Manager',263782516263,adminDetails.emailId,'7 Musadzi Rd, Mutora','Gokwe', function(){
		const pass = adminDetails.password;
		bcrypt.hash(pass, 10, function (err, hash){
			module.exports.insertLogin(1000, hash);
		});
	});	
};
